...
export function Header() {
  ...
  return (
    ...
    >
      <header
        className={`w-full border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.12)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] transition duration-500 ease-out backdrop-blur-[28px] ${open ? "rounded-[28px]" : "rounded-full"
          } ${scrolled
      ...
      >
        <div className="flex h-14 items-center justify-between px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href={githubAuthUrl}
              className="group hidden md:inline-flex relative items-center justify-center p-[2px] rounded-full overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(139,92,246,0.35)]"
            >
        ...
        {open && (
          <div className={`border-t border-white/[0.08] backdrop-blur-xl rounded-b-[28px] overflow-hidden md:hidden ${
            scrolled ? "bg-[#0f0f14]/50" : "bg-[#0f0f14]/35"
          }`}>
            <nav className="flex flex-col px-6 py-4 gap-3">
              ...
              <div className="px-4 pb-2 pt-1 border-t border-white/5">
                <Link
                  ...
                  className="group relative flex w-full items-center justify-center p-[2px] rounded-full overflow-hidden transition-all duration-300 hover:scale-[1.01]"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-[#8B5CF6] via-[#1A1A1A] to-[#8B5CF6] animate-gradient-shift z-0" />
                  <span className="relative flex w-full items-center justify-center gap-3 pl-1.5 pr-5 py-2 rounded-full bg-[#0F0F12] transition-colors duration-300 z-10">
                    <span className="flex w-6 h-6 items-center justify-center rounded-full bg-white shrink-0 shadow-sm">
                      <svg
                        aria-hidden="true"
                        width="14"
